...
function deleteRow(selected_row) {
  var row_value = selected_row.parentNode.parentNode.rowIndex;
  document.getElementById("table").deleteRow(row_value);
}

let colors_list = document.querySelector('select');
colors_list.addEventListener('change' , function () {
